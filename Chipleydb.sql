...
(1, 'Admin', 'njubichris@gmail.com', 'ChrisNjubi');
...
(11, 'Kenyan Food', 'Kenyan cuisine is diverse and influenced by various cultures and ethnic groups withing the country.', 'It combines elements of African, Arab, and Indian culinary traditions, resulting in a unique blend of flavors and ingredients.');
...
(1, 9, 'Dosa', 'I love Dosa very much. Its an Indian Food and Everybody loves it!'),
...
(10, 11, 'Nyama Choma', 'Nyama Choma is a delicious Kenyan goat meat delicacy you can enjoy any time of the day. It is nutritious, versatile, and oh-so finger-licking good!'),
...
INSERT INTO `orders` (`id`, `order_id`, `user_id`, `food_id`, `user_name`) VALUES
(3, 'RSTGF384345', '3', '1', 'Samprit');
...
(3, 'Chris Mbuthia', 'cmbuthia2547@gmail.com', '12345#');
